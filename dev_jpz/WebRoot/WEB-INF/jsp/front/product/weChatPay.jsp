...
<body style="background-color: #f5f5f5;">
	...
	<div class="content">
		...
		<div class="btn-group">
			<button class="back">
				<a href="<%=basePath%>myReservation/index.html">查看预定列表</a>
			</button>
		...
		$("#wcPay").click(function() {
			...
			//微信签名 
				...
				if (res.err_msg == "get_brand_wcpay_request:ok") { // 使用以上方式判断前端返回,微信团队郑重提示：res.err_msg将在用户支付成功后返回    ok，但并不保证它绝对可靠。 
					...
					window.location.href = "<%=basePath%>myReservation/index.html";//支付成功页面
				...
				{
					//TODO：支付失败的商户处理逻辑。
					window.location.href = "<%=basePath%>myReservation/index.html";//这里默认跳转到主页
				} else {
					window.location.href = "<%=basePath%>myReservation/index.html";//支付成功页面
				}
			});
