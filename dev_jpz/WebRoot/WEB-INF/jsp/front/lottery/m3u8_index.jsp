...
<title>Demo: play AES128 encrypted HLS video</title>
...
<body style="overflow-x:hidden;">
    ...
    <script type="text/javascript">
        var player = cyberplayer("playercontainer").setup({
            ...
            height: 320,
            stretching: "uniform",
            file: "http://live.366315.net/testapp/cl123456789.m3u8",
            autostart: true,
            repeat: false,
            volume: 100,
            controls: true,
    ...
    <%--
    http://live.366315.net/testapp/1111.m3u8
    http://demo-video.bj.bcebos.com/AdrenalineRush_encrypt.m3u8
--%>
</body>
