								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center' style="vertical-align: middle;">
											<a style="cursor: pointer;" title="${var.title}">
										    <c:choose>
										    <c:when test="${fn:length(var.title)>10}">
											${fn:substring(var.title,0,10)}...
											</c:when>
											<c:otherwise>
											${var.title}
											</c:otherwise>
											...
											<td class="center" style="vertical-align: middle;">
												...
												<div class="hidden-sm hidden-xs btn-group">
											        ...
											        <a class="btn btn-xs btn-warning" onclick="viewAuditLog('${var.articleID}');">操作记录</a>
											        <c:if test="${QX.pushArticle == 1 }">
											         <a class="btn btn-xs btn-warning" onclick="pushArticle('${var.articleID}');">推送</a>
											        </c:if>
												</div>
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.articleID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
