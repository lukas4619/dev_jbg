										...
										<div style="float: left;">
											<table>
												<tr>
													...
													<td>&nbsp;地址：</td>
													<td><input type="text" name="dbAddress" id="dbAddress" value="127.0.0.1" maxlength="200" placeholder="数据库连接地址" title="数据库连接地址"/></td>
													<td>&nbsp;端口：</td>
												...
												<tr>
													...
													<td>&nbsp;密码：</td>
													<td><input type="password" name="password" id="password" value="123456"  maxlength="32" placeholder="输入密码" title="密码"/></td>
													<td>&nbsp;库名：</td>
													<td><input type="text" name="databaseName" id="databaseName" value="jpz_store"  maxlength="32" placeholder="输入数据库名" title="数据库名"/></td>
												</tr>
											</table>
										</div>
