package com.fh.service.system.lottery.impl;
...
public class LotteryService implements LotteryManager{
	...
	@Override
	public List<PageData> listAllBy50(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("LotteryMapper.listAllBy50", pd);
	}
