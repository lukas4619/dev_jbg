...
public class ssm {
    ...
    static final String accessKeyId = "LTAI9vHcxiVLBYnb";
    static final String accessKeySecret = "oCNdptyvBVhwjViYGK2slM6pY4XPgK";
    ...
    public static Map<String,Object> sendSms(String sendPhone, String Code,int noteType) throws ClientException {
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_105230715");
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
         System.out.println("短信接口返回的数据----------------"+sendSms("18923798349","5684",1));
    }
}
