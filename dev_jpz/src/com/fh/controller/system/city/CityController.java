...
import com.fh.service.system.city.CityManager;
...
public class CityController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增City");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除City");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改City");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表City");
		...
		page.setPd(pd);
		List<PageData>	varList = cityService.list(page);	//列出City列表
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除City");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出City到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var4", varOList.get(i).getString("PROVINCEID"));	    //4
			varList.add(vpd);
		}
