...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("be004977a6844865bc693c1193be8d4a")){
			this.userjoin(message.replaceFirst("be004977a6844865bc693c1193be8d4a", ""),conn);
		}if(null != message && message.startsWith("e128d0b8807b4a128d6390c44a6accef")){
			this.userLeave(conn);
		}if(null != message && message.contains("e29149962e944589bb7da23ad18ddeed")){
			String toUser = message.substring(message.indexOf("e29149962e944589bb7da23ad18ddeed")+32, message.indexOf("eded77bdf35347249b2bacfa181c869d"));
			message = message.substring(0, message.indexOf("e29149962e944589bb7da23ad18ddeed")) +"[私信]  "+ message.substring(message.indexOf("eded77bdf35347249b2bacfa181c869d")+32, message.length());
