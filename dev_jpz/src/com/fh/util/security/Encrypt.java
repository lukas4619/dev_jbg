...
{
	public static final String PWD_KEY = "JBG2017117143227"; //固定秘钥
  ...
  public static String MD5ByKey(String input)
  {
    return MD5(input+PWD_KEY, Charset.defaultCharset());
  }
